...
const chosen = readline_sync_1.default.keyInSelect(scriptNames, 'Escolha um número para executar o script de conversão de unidade', { cancel: 'SAIR' });
if (chosen === -1)
    console.log('Saindo!');
else
    require(scripts[chosen].script);
